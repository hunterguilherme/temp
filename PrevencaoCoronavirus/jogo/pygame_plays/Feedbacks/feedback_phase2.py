...
class Bad_Message:
    ...
    def draw(self):
        ...
        if self.mode == "menu":
            self.game.screen.blit(self.surf_ind, (0, self.index * 80 + 200))

            for ind in range(3):
                self.game.screen.blit(self.menu_items_shadow[ind], (104, 204 + ind * 80))
                self.game.screen.blit(self.menu_items[ind], (100, 200 + ind * 80))
...
class Feedback_end_game2:
    ...
    def __init__(self,character_chosed, score, error):
        ...
        self.message = Phase2_end_perfect(self, score, error)
...
class Phase2_end_perfect:
    ...
    def __init__(self, game, score,error):
        ...
        self.menu_items = [
                game.font1.render("Máscaras: %s"%(score), 1, (255, 255, 255)),
        ...
        self.menu_items_shadow = [
                game.font1.render("Máscaras: %s"%(score), 1, (0, 0, 0)),
